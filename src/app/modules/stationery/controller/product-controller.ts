...
import { productSchemaValidate } from '../validation/product-validation';
...
export const product_Controller = {createProductController, getAllProducts,getProductById,updateProduct};
